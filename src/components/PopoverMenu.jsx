  ...
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <PopoverButton
            className={`px-3 py-2 rounded-lg text-sm font-medium inline-flex items-center gap-1.5 transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/75 ${
              open
          ...
          >
            <PopoverPanel className="absolute z-10 w-72 mt-2 transform -translate-x-1/2 left-1/2">
                ...
                <div className="grid gap-1 bg-white dark:bg-gray-800 p-2">
                  {props.links.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center gap-3 p-3 rounded-xl transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-gray-700/50 focus:outline-none focus-visible:ring focus-visible:ring-indigo-500/50"
                    >
