  ...
  return(
    <div className="w-56 text-right fixed bottom-[22rem] right-8 z-10">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className={`${isSettingsSideBarOpen ? 'invisible' : 'visible'} md:invisible md:hidden hover:cursor-pointer bg-blue-600 p-4 rounded fixed bottom-10 right-8 text-white z-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}>
            <MenuIcon
              height={30}
            />
          </Menu.Button>
