...
const MenuWindow = () => {
  ...
  return(
    <div className="w-56 text-right fixed bottom-[23.5rem] right-8 z-10">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="visible md:invisible md:hidden hover:cursor-pointer bg-blue-600 p-4 rounded-full fixed bottom-12 right-8 text-white z-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            <MenuIcon
              height={25}
            />
          </Menu.Button>
        ...
        >
          <Menu.Items className="absolute right-0 w-56 mt-2 origin-bottom-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
