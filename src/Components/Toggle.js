      ...
      <div className="flex flex-col">
        ...
        <Switch
          ...
          className={`${props.isOn ? 'bg-blue-600' : 'bg-slate-600'}
            relative inline-flex flex-shrink-0 h-[34px] w-[62px] md:h-[24px] md:w-[52px] border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
        >
